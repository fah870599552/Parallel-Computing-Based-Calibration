...
print(tip)
# 获取输入数据
input_file = "D://graduate1//SUMMER//Calibration//data//datachange//Newdata//6.00-6.59flow0902.csv"
#input_file = sys.argv[1]
lines = open(input_file, "r", encoding="utf_8_sig").readlines()
lines = [line.strip() for line in lines]
data = pd.DataFrame(pd.read_csv('D://graduate1//SUMMER//Calibration//data//datachange//Newdata//6.00-6.59flow0902.csv', sep=";"))
data = data.to_dict()
mm = 60
# 获取键值
keys = lines[0].split(';')
